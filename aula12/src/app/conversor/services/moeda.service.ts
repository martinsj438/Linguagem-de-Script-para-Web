...
export class MoedaService {
  ...
  private moedas: Moeda[];
    ...
    constructor() {}
  //base local através de moedasObj
    ...
    //converte a base de dados para uma listagem de moedas
    listarTodas(): Moeda[] {
      if (this.moedas) {
        return this.moedas;
      } 
      ...
      for (let moedaObj of this.moedasObj) {
        ...
        //Object.assign = pega um obj de origem e pega outra instância populada
